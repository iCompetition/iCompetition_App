...
alias iComp-giveAdminToUser='python3 /usr/local/lib/iCompetition/python/scripts/adminFlag.py give'
alias iComp-takeAdminFromUser='python3 /usr/local/lib/iCompetition/python/scripts/adminFlag take'